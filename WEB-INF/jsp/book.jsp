...
<link rel="stylesheet" type="text/css"
	href="assets/asset/css/plugins/simple-line-icons.css" />
<link rel="stylesheet" type="text/css"
		...
		<div id="left-menu">
			<div class="sub-left-menu scroll">
				<ul class="nav nav-list">
					...
					<li class="active ripple animated fadeInLeft"><a
						class="nav-header" href="book"> <span class="fa fa-book"></span>
							Books <span class="fa-angle-right fa right-arrow text-right"></span>
					</a></li>
					<li class="ripple animated fadeInRight"><a
						class="tree-toggle nav-header"> <span class="fa fa-money"></span>
							Rent History <span
					...
					<li class="ripple animated fadeInLeft"><a class="nav-header"
						href="customer"> <span class="fa fa-users"></span> Customer <span
							class="fa-angle-right fa right-arrow text-right"></span>
					</a></li>
					<li class="ripple animated fadeInRight"><a class="nav-header"
						href="employee"> <span class="fa fa-user"></span> Employee <span
							class="fa-angle-right fa right-arrow text-right"></span>
					</a></li>
					<li class="ripple animated fadeInLeft"><a class="nav-header"
						href="shelf"> <span class="fa fa-archive"></span> Shelf <span
							class="fa-angle-right fa right-arrow text-right"></span>
					</a></li>
					<li class="ripple animated fadeInRight"><a class="nav-header"
						href="publisher"> <span class="fa fa-newspaper-o"></span>
							Publisher <span class="fa-angle-right fa right-arrow text-right"></span>
					</a></li>
				</ul>
			</div>
		</div>
				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-body">
							...
							<button class="btn btn-success tree-toggle icon-box">
									<span class="fa fa-plus" /> Add Book</button><br><br>
								<ul class="nav nav-list tree">
									<form id="add-form" action="book/save" method="POST">
										<div class="col-md-6">
											<div class="form-group form-animate-text" style="margin-top:10px !important;">
												<input type="text" class="form-text mask-isbn" name="isbn" required>
												<span class="bar"></span> <label>ISBN</label>
											</div>
											<div class="form-group form-animate-text" style="margin-top:10px !important;">
												<input class="form-text" type="text"	name="title" required>
												<span class="bar"></span> <label>Title</label> 												
											</div>
											<div class="form-group form-animate-text" style="margin-top:10px !important;">
												<input type="text" class="form-text" name="author" required>
												<span class="bar"></span> <label>Author</label> 
											</div>										
											<div class="form-group form-animate-text" style="margin-top:10px !important;">
												<input type="text" class="form-text mask-year" name="releasedYear" required>
												<span class="bar"></span> <label>Released Year</label> 
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-animate-text" style="margin-top:10px !important;">
												<select class="form-text" name="publisher.id" required>
													<c:forEach var="publisher" items="${publishers }">
														<option value="${publisher.id }" label="${publisher.name }" />
													</c:forEach>
												</select>
												<span class="bar"> </span> <label>Publisher</label>
											</div>
											<div class="form-group form-animate-text" style="margin-top:10px !important;">
												<select class="form-text" name="shelf.id" required>
													<c:forEach var="shelf" items="${shelfs }">
														<option value="${shelf.id }" label="${shelf.category }" />
													</c:forEach>
												</select>
												<span class="bar"> </span> <label>Category</label>
											</div>
											<div class="form-group form-animate-text" style="margin-top:10px !important;">
												<input type="text" class="form-text mask-stock" name="bookStock.stock" required>
												<span class="bar"> </span> <label>Stock</label> 
											</div>
										</div>
										<div class="col-md-12">
				                        <input class="submit btn btn-primary" type="submit" value="Save"><br><br><br>
				                        </div>
									</form>
								</ul>
										...
										<c:forEach var="book" items="${books }">
											<tr>
												...
												<td style="text-align: center;">
													<button class="btn btn-success btn-xs detail-btn icon-box"
														data-id="${book.id}" title="Detail">
														<span class="icons icon-eye"></span>
													</button>&nbsp;
													<button class="btn btn-warning btn-xs update-btn icon-box"
														data-id="${book.id}" title="Update">
														<span class="icons icon-note"></span>
													</button>&nbsp;
													<button class="btn btn-danger btn-xs delete-btn icon-box"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form style="margin-top: 3%;">
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label>Released Year</label> <input type="text"
										class="form-control" name="releasedYear" id="releasedYear">
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									<label>Stock</label> <input type="hidden" class="form-control"
										name="bookStockId" id="bookStockId"> <input
										type="text" class="form-control" name="bookStock"
										id="bookStock">
								</div>
								<label> </label>
							</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" id="submit-update">Save
							changes</button>
					</div>
				</div>
				<!-- /.modal-content -->
